...
This repository includes several notebooks related to data mining tasks:
...
Each notebook explains the step-by-step analysis process starting from data loading until generating insights from the dataset.
